...
export const BitcoinStateKey = new MoveStruct({ name: `${$moduleName}::BitcoinStateKey`, fields: {
        dummy_field: bcs.bool()
    } });
export const BitcoinState = new MoveStruct({ name: `${$moduleName}::BitcoinState`, fields: {
